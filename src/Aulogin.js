  ...
  console.log(userData)
    ...
    try {
      ...
      if (response && response.data) {
        ...
        if (fromSignup) {
			// User is coming from signup, show the author form
			navigate('/authorform');
		} else {
			// User is not coming from signup, show the landing page
		...
		onSuccess: tokenResponse => console.log(tokenResponse),
                ...
                <Grid item lg={12} sx={{ marginBottom: '31px' }}>
                  <Typography sx={{ marginTop: '16px', color: '#292611', fontSize: '14px', fontWeight: '400', fontFamily: 'Space Grotesk' }}>
                    Already have an account?  <Link to="/ausign" style={{ textDecoration: 'none' }}><span style={{ fontSize: '14px', fontWeight: '700', fontFamily: 'Space Grotesk' }}>Sign up</span></Link>
                  </Typography>
                </Grid>
              </Grid>
            </Grid>
