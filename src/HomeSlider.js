...
const imagesToShow = isMobile ? 1 : 3;
  ...
  return (
    <>
    <Grid container lg={12} xs={12} sx={{margin:'auto',marginTop:'-39px',backgroundImage: `url(${Sl})`,backgroundSize:'100% 100%'}}>
    
    <Grid item lg={12} xs={12} >
       <Typography sx={{textAlign:'center',fontSize:isMobile?"26px":'56px',fontWeight:'500',lineHeight:'84px',color:'#053F5C',marginBottom:'70px',marginTop:'70px',fontFamily:'Space Grotesk'}}>Discover Fresh Titles</Typography> 
      </Grid>
