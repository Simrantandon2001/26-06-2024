...
<Grid item lg={8} >
  <Typography sx={{fontSize:mobile?"32px":'96px',fontWeight:'600',lineHeight:mobile?"45px":'124px',textAlign:'center',fontFamily:'Alegreya',color:'#053F5C',marginTop:mobile?"19px":"86px"}}>
      ...
      <Button 
										  ...
										  <Grid container lg={4} sx={{ justifyContent: "end", display: 'flex', alignItems: 'center' }}>
											  <Grid item lg={5.3}>
												  <Link to="/sign" style={{ textDecoration: 'none' }}>
													  <Button sx={{ fontSize: '10px', fontWeight: '700', color: '#053F5C', border: '2px solid #053F5C', textTransform: 'none', borderRadius: '6px', padding: '14px 24px', height: '32px', fontFamily: 'Space Grotesk' }} >Sign Up</Button>
												  </Link>
											  </Grid>
											  <Grid item lg={5.2}>
												  <Link to="/login" style={{ textDecoration: 'none' }}>
													  <Button sx={{ fontSize: '10px', fontWeight: '700', color: '#fff', backgroundColor: '#053F5C', textTransform: 'none', borderRadius: '6px', padding: '14px 30px', height: '32px', fontFamily: 'Space Grotesk', '&:hover': { backgroundColor: '#053F5C' } }} >Log In</Button>
												  </Link>
											  </Grid>
										  </Grid>
									  </Grid>
       ...
       <Grid container lg={12} sx={{backgroundImage: `url(${Create})`,minHeight:mobile?"1500px":'800px',backgroundSize:'100% 100%',backgroundRepeat:'no-repeat'}}>
                ...
                <Grid container lg={12} xs={12}>
                    <Grid item lg={8} xs={10} sx={{margin:mobile?'auto':''}}>
					  ...
					  <Grid container lg={12} xs={10} sx={{justifyContent:mobile?"center":'space-between',marginTop:'60px',margin:'auto'}}>
						  ...
						  <Grid item lg={10}>
							  <Typography style={{ fontFamily: 'Space Grotesk', fontSize:mobile?"20px": '30px', lineHeight: '64px', color: '#030605', marginTop: '44px' }}>
							  Authentic Reviews
								  </Typography>
							  </Grid>
							  <Grid item lg={10}>
						  ...
						  <Grid item lg={10}>
							  <Typography style={{fontFamily:'Space Grotesk',fontSize:mobile?"20px":'32px',lineHeight:'64px',color:'#030605',marginTop:'44px'}}>
							  Book Community
							  </Typography>  
							  </Grid>
							  <Grid item lg={10}>
...
<Grid item lg={12} xs={12} sx={{marginBottom:'100px',justifyContent:'center',display:'flex',alignItems:'center',marginLeft:'80px'}}>
  <Button style={{ backgroundColor: '#053F5C', color: 'white',fontSize: '16px',
