...
import Sl from './Images/Testii.png'
...
const imagesToShow = isMobile ? 1 : 3;
  ...
  return (
    <>
    <Grid container lg={12} sx={{margin:'auto',marginTop:'-39px',backgroundImage: `url(${Sl})`,backgroundSize:'100% 100%'}}>
    
    <Grid item lg={12}>
       <Typography sx={{textAlign:'center',fontSize:'40px',fontWeight:'700',lineHeight:'84px',color:'#EFEFEF',marginBottom:'70px',marginTop:'70px',fontFamily:'Space Grotesk'}}>Explore More</Typography> 
      </Grid>
...
<StarIcon sx={{ color: '#FFD700', marginRight: '5px' }} />{image.averageRating}</span>
              ...
              <Grid container lg={12}  sx={{justifyContent:"center",backgroundColor:'#fff',borderRadius:' 0px 0px 40px 40px'}}>
							...
							<Typography sx={{color:'#053F5C',fontSize:'20px',fontWeight:'700',fontFamily:'Space Grotesk',display:'flex',justifyContent:'center',textAlign:'center',padding:' 27px 31px 35px',letterSpacing:'0.3px'}}>{image.title
}</Typography>
</Grid>
